...
class VanillaVAE(BaseVAE):
    ...
    def __init__(self,
        ...
        if in_channels is None:
            in_channels = 1 # X-ray images are gray-scale.
        ...
        self.decoder_input = nn.Linear(latent_dim, flattened_hidden_size)
        ...
        self.final_layer = nn.Sequential(
                            ...
                            nn.LeakyReLU(),
                            nn.Conv2d(hidden_dims[-1], out_channels= 1, # Changed to one because x-ray images are gray-scale
